    ...
    <>
      <style>
        ...
        .hero-root::before {
          ...
          position: absolute;
          inset: 0;
          background: radial-gradient(ellipse 80% 60% at 60% -10%, rgba(220,38,38,.07) 0%, transparent 70%), 
          radial-gradient(ellipse 50% 50% at 100% 80%, rgba(249,115,22,.06) 0%, transparent 70%), 
          radial-gradient(ellipse 60% 70% at -10% 50%, rgba(220,38,38,.04) 0%, transparent 70%);
          pointer-events: none;
        }
        ...
        @media (max-width: 1023px) {
          .hero-eyebrow-text { color: rgba(255, 220, 220, 0.9); }
          .hero-eyebrow-dot  { background: rgba(220, 38, 38, 0.9); }
        }
        ...
        @media (max-width: 1023px) {
          ...
          .hero-headline span { color: rgba(255, 210, 210, 0.95); }
        }
        ...
        .hero-photo-frame {
          ...
          width: 100%;
          height: 90vh;
          box-shadow: 0 30px 80px rgba(220,38,38,.18), 0 10px 30px rgba(0,0,0,.12);
        }
        ...
        .hero-photo-frame::after {
          ...
          position: absolute;
          inset: 0;
          background: linear-gradient( to top, rgba(17,24,39,.55) 0%, rgba(17,24,39,.12) 40%,
            transparent 65%
          );
          pointer-events: none;
        }
        ...
        .hero-deco-ring {
          position: absolute;
          border-radius: 50%;
          border: 2px dashed rgba(220,38,38,.15);
          pointer-events: none;
          top: -2.5rem;
          right: -2.5rem;
          width: calc(100% + 5rem);
        ...
        .hero-deco-ring-2 {
          ...
          border-color: rgba(220,38,38,.07);
        }
